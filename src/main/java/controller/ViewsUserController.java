 ...
 * @author Matias
 */
@WebServlet(name = "ViewsUserController", urlPatterns = {"/view/user/*"})
public class ViewsUserController extends HttpServlet {
            ...
            if (userLogin == null) {
                ...
                switch (action) {
                    ...
                    case "/form-favourites":
                        ...
                        miDispatcher.forward(request, response);
                        break;
                    case "/form-change-password":
                        miDispatcher = request.getRequestDispatcher("/views/user/formChangePassword.jsp");
                        miDispatcher.forward(request, response);
                        break;
                    default:
